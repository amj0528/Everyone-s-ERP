	...
	<div class=col-lg-12>
		...
		<div class="panel-body">
			<input type="hidden" id="code" name="code" value="${code}" /> <input
				...
				value="<c:out value='${vo.num}' />" /> <input type="hidden"
				id="parentnum" name="parentnum" value="<c:out value='${vo.num}' />" />
			<input type="hidden" id="depth" name="depth"
				value="<c:out value='${vo.depth}' />" />
			...
			<div class="form-group row">
				...
				<div class="col-11">
					<textarea rows="10" cols="50" class="form-control" id="con"
						name="con">Re: <c:out value='${vo.content}' /></textarea>
			...
			<br />
			<div align="right">
				<button id="btnSave" type="button" style='color:white;' class="btn btn-warning">답글 등록</button>
