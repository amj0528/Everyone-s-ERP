   ...
   <div class=col-lg-12>
      ...
      <input type="hidden" id="pageindex" name="pageindex" value="${pageindex}" />
         <input type="hidden" id="code" name="code" value="${code}" /> <input
            type="hidden" id="num" name="num" value="${num }" /> <input type="hidden"
            id="parentnum" name="parentnum" value="0" /> <input type="hidden"
            id="depth" name="depth" value="${vo.depth }" />

         <div class="form-group row">
            <label class="control-label col-1" for="notice">공지글</label>
            <div class="col-11">
               <input class="checkbox" type="checkbox" id="notice" name="notice" <c:if test="${vo.notice eq true}">checked='checked'</c:if>>
         ...
         <div class="form-group row">
            ...
            <div class="col-11">
               <textarea rows="10" cols="50" class="form-control" id="con"
                  name="con"><c:out value="${vo.content }"></c:out> </textarea>
         ...
         <br />
         <div align="right">
         <button id="btnSave" type="button" class="btn btn-warning">수정</button>
                  ...
                  $("#boardDeleteBtn").on("click",function(e){
                        ...
                        if (confirm("정말로 삭제하시겠습니까?")) {
                           ...
                           $.ajax({
                              ...
                              url : "/board/delete", // 컨트롤러에서 대기중인 URL 주소이다.
                              beforeSend : function(xhr) {
                                 xhr.setRequestHeader(csrfHeaderName, csrfTokenValue);
                              },
