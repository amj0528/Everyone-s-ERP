...
$(document).ready(function(e){
      ...
      e.preventDefault();
         ...
         $.ajax({
            ...
            success : function(res) { // 비동기통신의 성공일경우 success콜백으로 들어옵니다. 'res'는 응답받은 데이터이다.
               ...
               window.location.href="/admin/board/select?code="+$("#code").val(); //비동기 식 링크 넘기는 방식. 동기식은 form 액션값 바꿔서 보냄.
            },
   ...
   $('#boardGetBtn').on(
            ...
            function(e) {
               ...
               window.location.href = "/admin/board/get?code="
                   + $("#code").val() + "&num="
                   + $("#num").val();
            });
