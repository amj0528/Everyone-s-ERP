...
<div class="row">
	<div class="col-lg-12">
		<h1 id="titlename" class="page-header">스케쥴 수정</h1>
	</div>
</div>
		...
		<div class="panel-body">
			...
			<div class="form-group row">
				...
				<div class="col-11">
					...
					value="<c:out value='${vo.title}'/>" maxlength="100">
				</div>
			</div>
			<div class="form-group row">
				<label class="control-label col-1" for="period">기간</label>
				<div class="col-11">
					<input class="form-control" style="display:inline-block; width:48%;" id="startday" name='startday' type="datetime-local" value="<c:out value='${vo.startday}'/>" >
					<span>&nbsp;&nbsp;&nbsp;~&nbsp;&nbsp;&nbsp;</span>
					<input class="form-control" style="display:inline-block; width:47%;" id="endday" name='endday' type="datetime-local"  value="<c:out value='${vo.endday}'/>" >
				</div>
			</div>
	...
	$("#boardModBtn").on("click",function(e) {
		...
		$.ajax({
			...
			success : function(res) { // 비동기통신의 성공일경우 success콜백으로 들어옵니다. 'res'는 응답받은 데이터이다.
				...
				window.location.href = "/schedule/get?num=" + $("#num").val();
			},
